      ...
      if (time < this.configService.bot.salesLookbackSeconds) {
        ...
        try {
          sales.push({
            ...
            txHash: sale.txHash,
            cacheKey: cacheKey,
            permalink: `https://marketplace.forgottenrunes.com/${c.chain}/asset/${c.tokenContract}:${sale.token.tokenId}`,
            thumbnail,
      ...
      if (time < this.configService.bot.salesLookbackSeconds) {
        ...
        try {
          const formattedListing = {
            ...
            sellerName: sellerName ? `(${sellerName})` : ``,
            cacheKey,
            fmLink: `https://marketplace.forgottenrunes.com/${c.chain}/asset/${c.tokenContract}:${tokenId}`,
